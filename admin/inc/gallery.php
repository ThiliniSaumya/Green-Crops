...
if($_SERVER['REQUEST_METHOD']=='POST'  && !empty($_POST['discription'])){
	...
	$sql = "INSERT INTO `gallery`( `discription`, `image`)";
...
<div class="maingallery clearfix">	
	<h1 id="main_topic" style="margin-top: 5px;margin-bottom:10px; ">Manage Gallery</h1>
...
<?php
        ...
        echo"    </div>";
        echo"            <button style=\"width: 100%;\" class=\"btn btn-small bg-danger btn-outline-light btn-sm \"onclick=\"location.href='inc/deletegalleryphp.php?user_id={$row['id']}';\">Delete</button>";
        echo"  </div>            ";
                    } 
